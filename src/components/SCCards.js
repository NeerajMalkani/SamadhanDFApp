import { height } from "@fortawesome/free-solid-svg-icons/faPowerOff";
  ...
  return (
    ...
    >
      ...
      <Card.Cover source={{ uri: image }} style={[Styles.height250]}/>
        <Card.Content style={[Styles.positionAbsolute,Styles.Bottom0,{backgroundColor:"rgba(15, 15, 15,0.4)"},Styles.width100per, Styles.height80]}>
