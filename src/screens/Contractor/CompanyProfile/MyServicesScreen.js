...
const ContractorMyServicesScreen = ({ navigation }) => {
 ...
 //#region Functions
  ...
  const FetchData = (from) => {
    ...
    Provider.getAll(`contractorcompanyprofile/getmyservices?${new URLSearchParams(params)}`)
      .then((response) => {
  ...
  const AddCallback = () => {
    navigation.navigate("AddContractorMyServicesScreen", { type: "add", fetchData: FetchData });
  };
