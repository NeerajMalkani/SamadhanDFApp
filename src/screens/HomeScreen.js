...
LogBox.ignoreLogs(["Non-serializable values were found in the navigation state", "Material-UI: The `css` function is deprecated. Use the `styleFunctionSx` instead"]);
...
const HomeScreen = ({ route, navigation }) => {
  ...
  return (
    <View style={[Styles.flex1, Styles.backgroundSecondaryLightColor]}>
      <View style={[Styles.width100per, Styles.height64, Styles.backgroundColorWhite, Styles.flexRow, Styles.flexAlignCenter, Styles.paddingHorizontal16, Styles.BottomShadow]}>
        {/* menu icon */}
          ...
          {userRoleID === "2" ? (
            <View>
              ...
              <View style={[Styles.width100per, Styles.boxTopElevation, Styles.borderTopRadius24, Styles.paddingTop12, Styles.paddingBottom16]}>
                <View style={[Styles.paddingHorizontal16]}>
                  <View style={[Styles.horizontalArrowLineBG, Styles.flexAlignSelfCenter, Styles.borderRadius16, Styles.marginBottom16, { width: "20%", height: 6 }]}></View>
                  <View>
                    <Text style={[Styles.HomeTitle]}>Users</Text>
                  </View>
                  <View style={[Styles.paddingTop16]}>
                    <View style={[Styles.borderRadius8, Styles.homeBox, Styles.paddingHorizontal12, Styles.paddingVertical8, Styles.flexRow, Styles.flexAlignCenter, { height: 92 }]}>
                      <View style={[Styles.width70]}>
                        <Text style={[Styles.userCount]}>{_user_count != null ? _user_count[2].roleCount : "0"}</Text>
                        <Text style={[Styles.userCountLabel, Styles.marginTop4]}>{_user_count != null ? _user_count[2].roleName : ""}</Text>
                      </View>
                      <View style={[Styles.userCountDevider]}></View>
                      <View style={[Styles.width70]}>
                        <Text style={[Styles.userCount]}>{_user_count != null ? _user_count[1].roleCount : "0"}</Text>
                        <Text style={[Styles.userCountLabel, Styles.marginTop4]}>{_user_count != null ? _user_count[1].roleName : ""}</Text>
                      </View>
                      <View style={[Styles.userCountDevider]}></View>
                      <View style={[Styles.width70]}>
                        <Text style={[Styles.userCount]}>{_user_count != null ? _user_count[0].roleCount : "0"}</Text>
                        <Text style={[Styles.userCountLabel, Styles.marginTop4]}>{_user_count != null ? _user_count[0].roleName : ""}</Text>
                      </View>
                      <View style={[Styles.userCountDevider]}></View>
                      <View style={[Styles.width70]}>
                        <Text style={[Styles.userCount]}>{_user_count != null ? _user_count[3].roleCount : "0"}</Text>
                        <Text style={[Styles.userCountLabel, Styles.marginTop4]}>{_user_count != null ? _user_count[3].roleName : ""}</Text>
                      </View>
                    </View>
                  ...
                  <View style={[Styles.marginTop16, Styles.borderRadius8, Styles.homeBox, { height: 140 }]}>
                    <ImageBackground source={require("../../assets/user-access.jpg")} resizeMode="cover" style={[{ flex: 1, justifyContent: "center" }]} imageStyle={{ borderRadius: 8 }}>
                      <Text style={[Styles.positionAbsolute, Styles.marginTop8, Styles.marginStart16, Styles.fontSize18, Styles.textColorWhite, Styles.fontBold, { top: 8 }]}>Control User Access</Text>
                    </ImageBackground>
                  </View>
                  <View style={[Styles.marginTop16, Styles.borderRadius8, Styles.homeBox, { height: 140 }]}>
                    <ImageBackground source={require("../../assets/user-access.jpg")} resizeMode="cover" style={[{ flex: 1, justifyContent: "center" }]} imageStyle={{ borderRadius: 8 }}>
                  ...
                  <View style={[Styles.paddingTop16]}>
                    ...
                    <View style={[Styles.marginTop16, Styles.flexRow, Styles.flexSpaceBetween]}>
                      <TouchableOpacity
                        ...
                        style={[Styles.borderRadius8, Styles.homeBox, Styles.flexColumn, Styles.flexJustifyCenter, Styles.flexAlignCenter, { width: 156, height: 72 }]}
                      >
                        <Icon name="archive-arrow-down" size={22} color={theme.colors.serviceCatelogueIcons} />
                  ...
                  <View style={[Styles.paddingTop16]}>
                    ...
                    <View style={[Styles.marginTop16, Styles.flexRow, Styles.flexSpaceBetween]}>
                      <TouchableOpacity
                        ...
                        style={[Styles.borderRadius8, Styles.homeBox, Styles.flexColumn, Styles.flexJustifyCenter, Styles.flexAlignCenter, Styles.paddingHorizontal12, { width: 100, height: 108 }]}
                      >
                        <Icon name="archive-arrow-down" size={22} color={theme.colors.productionIcons} />
                        <Text style={[Styles.buttonIconLabel]}>Brand Conversion Value</Text>
                      </TouchableOpacity>
                      <TouchableOpacity
                        onPress={() => {
                      ...
                      >
                        <Icon name="archive-arrow-down" size={22} color={theme.colors.productionIcons} />
                        <Text style={[Styles.buttonIconLabel]}>Mass of zinc coting</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                  <View style={[Styles.paddingTop16]}>
                    ...
                    <View style={[Styles.marginTop16, Styles.flexRow]}>
                      <TouchableOpacity
                        ...
                        style={[Styles.borderRadius8, Styles.homeBox, Styles.flexColumn, Styles.flexJustifyCenter, Styles.flexAlignCenter, Styles.paddingHorizontal12, { width: 100, height: 72 }]}
                      >
                      ...
                      <TouchableOpacity
                        ...
                        style={[Styles.borderRadius8, Styles.homeBox, Styles.flexColumn, Styles.flexJustifyCenter, Styles.flexAlignCenter, Styles.paddingHorizontal12, { width: 100, height: 72, marginLeft: 16 }]}
                      >
                        <Icon name="archive-arrow-down" size={22} color={theme.colors.pocketDiaryIcons} />
                  ...
                  <View style={[Styles.paddingTop12, Styles.marginTop24, Styles.padding16, Styles.width100per, Styles.borderRadius8, Styles.jobBG, { height: 110, elevation: 5 }]}>
                  ...
                  <View style={[Styles.marginTop16, Styles.borderRadius8, Styles.homeBox, { height: 140 }]}>
                    <ImageBackground source={require("../../assets/referral-wallet-1.jpg")} resizeMode="cover" style={[{ flex: 1, justifyContent: "center" }]} imageStyle={{ borderRadius: 8 }}>
                      <Text style={[Styles.positionAbsolute, Styles.marginTop8, Styles.marginStart16, Styles.fontSize18, Styles.textColorWhite, Styles.fontBold, { top: 8 }]}>Refer and Earn</Text>
                    </ImageBackground>
                  </View>
                </View>
              </View>
            ...
            <View>
              ...
              <View style={[Styles.width100per, Styles.padding16, Styles.positionRelative]}>
                ...
                >
                  <ImageBackground source={require("../../assets/material-calculator-with-element-bg.jpg")} resizeMode="cover" style={[{ flex: 1, justifyContent: "center" }]} imageStyle={{ borderRadius: 8 }}>
                    <Text style={[Styles.positionAbsolute, Styles.marginTop8, Styles.marginStart16, Styles.fontSize18, Styles.textColorWhite, Styles.fontBold, { top: 8 }]}>Material Calculator</Text>
                  </ImageBackground>
                </TouchableOpacity>
                {/* Material Calculator */}
                <View style={[Styles.paddingTop16]}>
                  <View style={[Styles.bordergray, Styles.padding16, Styles.borderRadius8]}>
                    ...
                    <View style={[Styles.marginTop16, Styles.flexRow, Styles.flexSpaceBetween]}>
                      <TouchableOpacity
                        ...
                        style={[Styles.borderRadius8, Styles.homeBox, Styles.flexColumn, Styles.flexJustifyCenter, Styles.flexAlignCenter, Styles.paddingHorizontal12, { width: 140, height: 72 }]}
                      >
                        <Icon name="archive-arrow-down" size={22} color={theme.colors.productionIcons} />
                      ...
                      <TouchableOpacity
                        ...
                        style={[Styles.borderRadius8, Styles.homeBox, Styles.flexColumn, Styles.flexJustifyCenter, Styles.flexAlignCenter, Styles.paddingHorizontal12, { width: 140, height: 72, marginLeft: 16 }]}
                      >
                        <Icon name="archive-arrow-down" size={22} color={theme.colors.productionIcons} />
                ...
                <TouchableOpacity
                  ...
                  style={[Styles.width100per, Styles.height150, Styles.flexRow, Styles.marginTop16, Styles.borderRadius8, { elevation: 4 }]}
                >
                  <ImageBackground source={require("../../assets/pocket-diary-bg.png")} resizeMode="cover" style={[{ flex: 1, justifyContent: "center" }]} imageStyle={{ borderRadius: 8 }}>
                    <Text style={[Styles.positionAbsolute, Styles.marginTop8, Styles.marginStart16, Styles.fontSize18, Styles.textColorWhite, Styles.fontBold, { top: 8 }]}>Pocket Diary</Text>
                  </ImageBackground>
                </TouchableOpacity>
                {/* Pocket Diary */}
                ...
                <View style={[Styles.width100per, Styles.height150, Styles.flexRow, Styles.marginTop16, Styles.borderRadius8, { elevation: 4 }]}>
                  <ImageBackground source={require("../../assets/jobs-bg.jpg")} resizeMode="cover" style={[{ flex: 1, justifyContent: "center" }]} imageStyle={{ borderRadius: 8 }}>
                    <Text style={[Styles.positionAbsolute, Styles.marginTop8, Styles.marginStart16, Styles.fontSize18, Styles.textColorWhite, Styles.fontBold, { top: 8 }]}>Looking For Jobs ?</Text>
                  </ImageBackground>
                </View>
                {userRoleID !== "2" && (
                  <>
