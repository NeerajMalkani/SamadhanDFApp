    ...
    <View style={[Styles.flex1]}>
      <ScrollView style={[Styles.flex1, Styles.backgroundColor, { marginBottom: 64 }]} keyboardShouldPersistTaps="handled">
        <View style={[Styles.padding16]}>
          ...
          <Dropdown label="Brand Name (Raw Material)" data={brandData} onSelected={onBrandNameSelected} isError={errorBN} selectedItem={brandName} reference={brandDDRef} />
          <HelperText type="error" visible={errorBN}>
            {communication.InvalidBrandName}
          </HelperText>
          <TextInput mode="flat" label="Conversion Value" value={conversionvalue} onChangeText={onCVChanged} error={conversionvalueError} editable={false} dense style={[Styles.marginTop12, Styles.backgroundSecondaryColor]} />
