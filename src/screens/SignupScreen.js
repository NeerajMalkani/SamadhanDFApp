      ...
      <ScrollView keyboardShouldPersistTaps="handled">
        <View style={[Styles.padding32, Styles.paddingTop0]}>
          ...
          <View style={[Styles.flexRow, Styles.flexAlignCenter, Styles.paddingTop8]}>
            <TextInput mode="flat" dense disabled value={otp1} onChangeText={onOTP1Changed} style={[Styles.width48, Styles.height48, Styles.textCenter]} />
            <TextInput mode="flat" dense disabled value={otp2} onChangeText={onOTP2Changed} style={[Styles.width48, Styles.height48, Styles.textCenter, Styles.marginStart8]} />
            <TextInput mode="flat" dense disabled value={otp3} onChangeText={onOTP3Changed} style={[Styles.width48, Styles.height48, Styles.textCenter, Styles.marginStart8]} />
            <TextInput mode="flat" dense disabled value={otp4} onChangeText={onOTP4Changed} style={[Styles.width48, Styles.height48, Styles.textCenter, Styles.marginStart8]} />
          ...
          <Button mode="contained" style={[Styles.marginTop24]} onPress={() => ValidateSignup()}>
            Submit
          </Button>
        </View>
      </ScrollView>
