...
const EstimationContractorStatusScreen = ({ route, navigation }) => {
    ...
    const EditCallback = (data, rowMap) => {
        setSnackbarText("Function Coming Soon");
        ...
        return (
            <View style={[Styles.backgroundColor, Styles.borderBottom1, Styles.paddingStart16, Styles.flexJustifyCenter, { height: 72 }]}>
                <List.Item
                    ...
                    description={`Quotation Amount: ${data.item.quotation_amount}\nAccepted Status: ${data.item.accept_status == "1" ? "Accepted" : "Not Accepted"} `}
                ...
                <View style={[Styles.flex1, Styles.flexColumn, Styles.backgroundColor]}>
                    ...
                    <SwipeListView
                        ...
                        renderHiddenItem={(data, rowMap) => {
                            if (data.item.project_allot_status == "0" && data.item.accept_status == "1") {
