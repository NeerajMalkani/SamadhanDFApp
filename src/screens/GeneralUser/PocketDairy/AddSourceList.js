      ...
      <View style={[Styles.backgroundColor, Styles.borderBottom1, Styles.paddingStart16, Styles.flexJustifyCenter, { height: 72 }]}>
        <List.Item
          ...
          onPress={() => {
            ...
            setPaymentType(data.item.paymentType);
 ...
 //#endregion 
  ...
  return (
    <View style={[Styles.flex1]}>
      <Header navigation={navigation} title="Income List" />
      {isLoading ? (
      ...
      <RBSheet ref={refRBSheet} closeOnDragDown={true} closeOnPressMask={true} dragFromTopOnly={true} height={420} animationType="fade" customStyles={{ wrapper: { backgroundColor: "rgba(0,0,0,0.5)" }, draggableIcon: { backgroundColor: "#000" } }}>
        <View>
          <Title style={[Styles.paddingHorizontal16]}>{entryTypeName}</Title>
          <ScrollView>
          ...
          <List.Item title="EntryType Name" description={entryTypeName} />
            ...
            <List.Item title="Payment Type" description={paymentType} />
