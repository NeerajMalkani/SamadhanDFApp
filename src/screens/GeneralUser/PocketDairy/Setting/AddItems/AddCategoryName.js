...
const AddCategoryName = ({ route, navigation }) => {
    ...
    <View style={[Styles.flex1]}>
      <ScrollView style={[Styles.flex1, Styles.backgroundColor, { marginBottom: 64 }]} keyboardShouldPersistTaps="handled">
        <View style={[Styles.padding16]}>
          ...
          <TextInput mode="flat" label="Category Name" value={categoryName} returnKeyType="next" onSubmitEditing={() => ref_input2.current.focus()} onChangeText={onCategoryNameChanged} style={{ backgroundColor: "white" }} error={error} />
