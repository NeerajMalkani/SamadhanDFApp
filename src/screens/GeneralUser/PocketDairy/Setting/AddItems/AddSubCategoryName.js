...
const AddSubCategoryName = ({ route, navigation }) => {
    ...
    <View style={[Styles.flex1]}>
      <ScrollView style={[Styles.flex1, Styles.backgroundColor, { marginBottom: 64 }]} keyboardShouldPersistTaps="handled">
        <View style={[Styles.padding16]}>
          ...
          <TextInput mode="flat" label=" Sub Category Name" value={subCategoryName} returnKeyType="next" onSubmitEditing={() => ref_input2.current.focus()} onChangeText={onSubCategoryNameChanged} style={{ backgroundColor: "white" }} error={subCategoryError} />
          <HelperText type="error" visible={subCategoryError}>
            {communication.InvalidSubCategoryName}
          </HelperText>

          <TextInput mode="flat" label=" Notes" value={notes} returnKeyType="next" onSubmitEditing={() => ref_input2.current.focus()} onChangeText={onSubCategoryNameChanged} style={{ backgroundColor: "white" }} error={notesError} />
...
export default AddSubCategoryName;
