...
function EditProductForProduction({ route, navigation }) {
  ...
  const update = () => {
    let params = {
      data: {
        ...
        mfpp_refno: route.params.data.mfpp_refno,
    ...
    Provider.createDFManufacturer(
      Provider.API_URLS.productforproductionupdate,
      params
    )
      .then((response) => {
        ...
        if (response.data && response.data.code == "200") {
          if (response.data.data) {
            ...
            setData((prev) => {
              return {
                ...prev,
                thick_service_name: filter
                  ? filter?.thick_service_name
                  : response.data.data[0].thick_service_name,
              };
            });
          }
        }
              ...
              setData((prev) => {
                return {
                  ...
                  thick_category_name: filter
                    ...
                    : response.data.data[0].thick_category_name,
                };
              });
            }
          }
          ...
          if (response.data && response.data.code == "200") {
            if (response.data.data) {
              ...
              setData((prev) => {
                return {
                  ...prev,
                  thick_product_name: filter
                    ? filter?.product_name
                    : response.data.data[0].product_name,
                };
              });
            }
          }
...
export default EditProductForProduction;
