...
function OpeningStockScrap({navigation}) {
   ...
   //#region Functions
    ...
    const AddCallback = () => {
      navigation.navigate("AddOpeningStockScrap", { type: "add", fetchData: FetchData });
    };
      ...
      <RBSheet ref={refRBSheet} closeOnDragDown={true} closeOnPressMask={true} dragFromTopOnly={true} height={420} animationType="fade" customStyles={{ wrapper: { backgroundColor: "rgba(0,0,0,0.5)" }, draggableIcon: { backgroundColor: "#000" } }}>
        <View>
          ...
          <ScrollView>
            ...
            <List.Item title="Product Name >> Brand" description={productName} />
